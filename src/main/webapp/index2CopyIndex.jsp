...
<h2>Delete a student by Name </h2>

        <form action="deleteStudentByName.jsp">
            <div class="form-outline mb-4">
                <input type="text" name="name" value="Name..." onclick="this.value=''"/><br/>
            </div>
...
<h2>Tracks list from the index.jsp file</h2>
...
<h1 style="background-color:DodgerBlue;">Music Player</h1>
<p style="background-color:Tomato;">
  <br><br>
      <audio controls audioplay
      <source src = "music/Bomel - Ossumba.mp3" type = "audio/mpeg"> </source>
...
<br></br>
 ...
 <form action="player.jsp">
        ...
        <br/>
        <input type="submit" value="Player" class="btn btn-primary btn-block"/>
        </form>
...
<form action="index1.jsp">
        ...
        <br/>
        <input type="submit" value="Welcome Page" class="btn btn-primary btn-block"/>
        </form>
